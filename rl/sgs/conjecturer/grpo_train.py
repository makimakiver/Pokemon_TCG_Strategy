...
from rl.sgs.conjecturer.cispo_train import train_conjecturer_cispo


def train_conjecturer_grpo(*_, **__):
    raise NotImplementedError(
        "GRPO is not used here — the conjecturer fine-tune is CISPO. "
        "Use rl.sgs.conjecturer.cispo_train.train_conjecturer_cispo "
        "(or `python -m rl.sgs.conjecturer.cispo_train`).")
