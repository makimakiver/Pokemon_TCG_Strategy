...
This is the apples-to-apples measure of the SGS net in real games.
  ...
  docker run --rm --platform=linux/amd64 -v "$PWD":/app -w /app \
    ...
    --entrypoint python cabt-rl -m rl.inference.eval.eval_sgs_mcts
"""
import importlib
import os
import sys
...
from rl.training.solver.policy import load as load_policy
from rl.engine import encode
from rl.engine.scenario import ScenarioSpec
from rl.training.solver.mcts import MCTS
from rl.training.curriculum.targets import _pokemon_ids, _visible_ids, _hidden_pool, _take
from rl.training.solver.train_solver import _load_deck
