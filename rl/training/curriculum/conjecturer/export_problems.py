...
Examples:
  # CPU / Docker fallback
  python -m rl.training.curriculum.conjecturer.export_problems --backend parametric --out rl/runs/problems.jsonl
  # Mac mini (good adapter)
  python -m rl.training.curriculum.conjecturer.export_problems --backend llm \
...
from rl.training.curriculum.problem_set import problem_row, write_problem_set
