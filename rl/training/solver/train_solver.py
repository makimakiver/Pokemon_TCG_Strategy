...
try:
    from rl.engine.env import TCGEnv          # engine-only; used only as a type annotation
except Exception:                    # non-engine host: annotation is a string (PEP 563)
    TCGEnv = None
from rl.training.solver.policy import PointerPolicy, prior_weight_at, save as save_policy
