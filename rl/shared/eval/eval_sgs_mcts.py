...
This is the apples-to-apples measure of the SGS net in real games.
  ...
  docker run --rm --platform=linux/amd64 -v "$PWD":/app -w /app \
    ...
    --entrypoint python cabt-rl -m rl.shared.eval.eval_sgs_mcts
"""
import importlib
import os
import sys
...
from rl.shared.policy import load as load_policy
from rl.shared.engine import encode
from rl.shared.engine.scenario import ScenarioSpec
from rl.sgs.mcts import MCTS
from rl.sgs.targets import _pokemon_ids, _visible_ids, _hidden_pool, _take
from rl.sgs.train_solver import _load_deck
