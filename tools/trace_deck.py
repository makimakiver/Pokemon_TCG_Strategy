...
A = importlib.import_module(os.environ.get("A_MOD","agents.bare_agent"))
opp_name = sys.argv[1] if len(sys.argv) > 1 else "agents.main_cur"
    ...
    for _ in range(10000):
        ...
        for lg in (obs.get("logs") or []):
            ...
            if t == 15 and lg.get("playerIndex") == a_seat:     # ATTACK by A
                ...
                if cards.get(lg.get("cardId")) == "__never__" and saw_honch is None:
