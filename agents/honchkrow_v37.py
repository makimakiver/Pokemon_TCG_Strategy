            ...
            if card is not None:
                if context in (SelectContext.SWITCH, SelectContext.TO_ACTIVE):
                    ...
                    if card.id == MURKROW:
                        ...
                        # v37: Mimikyu is 60hp Fighting-RESISTANT + free retreat -> a cheap wall.
                        # Vs Fighting it absorbs a hit (Aura Jab 130-30=100 > 60 still KOs, but it
                        # banks a turn at zero prize investment; promote as a stall/wall body).
                        score = 110 if opp_fighting else 60
