...
os.environ.setdefault("BARE_DECK", os.path.join(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "decks", "deck_dragapult_v12b.json"))
...
def agent(obs_dict):
    ...
    if False and active_is_drag and HEROS_CAPE in hand:  # v12b: no Cape (Legacy-only deck)
