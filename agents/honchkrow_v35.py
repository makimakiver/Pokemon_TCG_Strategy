...
my_deck = ([463] * 4 + [891] * 4 + [473] * 2 + [474] * 1 + [414] * 2 +
           [140] * 1 +                       # Fezandipiti ex (210hp Darkness closer, deck 26801)
           [1220] * 4 + [1216] * 4 + [1217] * 4 + [1219] * 4 + [1218] * 4 +
           [1134] * 4 + [1077] * 4 +         # Transceiver, Roto-Stick (supporter search = ammo)
           [1152] * 3 + [1121] * 1 +         # Poke Pad, Ultra Ball
           [1088] * 1 + [1156] * 1 + [1175] * 1 +   # Prime Catcher (gust), Lucky Helmet, Brave Bangle
           [1257] * 3 +                       # Team Rocket's Factory
           [15] * 4 + [17] * 4)               # TR Energy, Ignition
# deck = limitlesstcg 26801
